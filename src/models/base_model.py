"""
BaseModel for ODE-based Models

This file contains the BaseModel class for ODE-based models.
It is used as the foundation for building specific models like the ECG model.
"""
...
class BaseModel:
    ...
    def solve(self, t: np.ndarray, solver: str = "Euler", verbose: bool = True,
        ...
        # Get initial states as array (extract only initial value if tuple)
        state_names = list(self.states.keys())
        y0 = np.array([
            self.states[name][0] if isinstance(self.states[name], tuple) else self.states[name]
